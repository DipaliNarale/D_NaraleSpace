...
public interface MechanicalLabTestRepository {
	...
	List<CollectedSamplesDto> getCollectedSamples(String workcenter, String soNo, String testPlanNo, String soItemNo,
			String batchNo, String sampleNo);
